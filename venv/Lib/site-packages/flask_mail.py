...
class Message(object):
    ...
    def __init__(self, subject='',
        ...
        sender = sender or current_app.extensions['email'].default_sender
    ...
    def _message(self):
        """Creates the email"""
        ascii_attachments = current_app.extensions['email'].ascii_attachments
...
class _MailMixin(object):
    ...
    def connect(self):
        """Opens a connection to the email host."""
        app = getattr(self, "app", None) or current_app
        try:
            return Connection(app.extensions['email'])
        except KeyError:
...
class Mail(_MailMixin):
    ...
    def init_app(self, app):
        """Initializes your email settings from the application settings.
