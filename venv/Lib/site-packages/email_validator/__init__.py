...
class ValidatedEmail(object):
    ...
    """If True, the SMTPUTF8 feature of your email relay will be required to transmit messages
...
def validate_email_domain_part(domain):
    ...
    # must either support SMTPUTF8 or the email client must convert the
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # If there was no MX, A, or AAAA record, then email to
